...
current_dir = r"N:\_USER_GLOBAL\PETREL\Prizm\wf\Vienna\seismicAttributes_Panel_app"
...
# --- 2. IMPORT CONSTANTS ---
try:
    import seismicAttributes_constants as constants
...
panel_script = str(app_root / "seismicAttributes_main.py")
...
if process.poll() is not None:
    ...
    url = "http://localhost:5006/seismicAttributes_main"
    print(f"Opening: {url}")
    webbrowser.open(url)
