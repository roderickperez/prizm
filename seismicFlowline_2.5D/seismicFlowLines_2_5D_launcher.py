# N:\_USER_GLOBAL\PETREL\Prizm\wf\Vienna\seismicFlowLines_2_5D_Panel_app\seismicFlowLines_2_5D_launcher.py
...
current_dir = r"N:\_USER_GLOBAL\PETREL\Prizm\wf\Vienna\seismicFlowLines_2_5D_Panel_app"
...
# --- 2. IMPORT CONSTANTS ---
try:
    # Updated import to match the new constants filename
    import seismicFlowLines_2_5D_constants as constants
...
selected_cube_guid = None  # <--- NEW VARIABLE
...
try:
    ...
    if 'parameters' in locals() and 'seismic_input' in parameters:
        ...
        # Fetch actual object to get the name for display purposes
...
snapshot_payload = {
    ...
    "selected_cube_guid": selected_cube_guid  # <--- SAVE GUID TO JSON
}
...
# Updated script name
panel_script = str(app_root / "seismicFlowLines_2_5D_main.py")
...
if process.poll() is not None:
    ...
    # Updated URL
    url = "http://localhost:5006/seismicFlowLines_2_5D_main"
    print(f"Opening: {url}")
    webbrowser.open(url)
