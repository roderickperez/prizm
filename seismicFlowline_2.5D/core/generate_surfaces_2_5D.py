...
def generate_surfaces_2_5D(seismic_line, sample_interval_x, overlap_threshold = 0.95, linewidth =1,  mode = 'both'):
...
surfaces = generate_surfaces_2_5D(seismic_line, overlap_threshold=overlap_threshold,
