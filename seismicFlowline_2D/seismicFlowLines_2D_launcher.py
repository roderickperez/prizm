# N:\_USER_GLOBAL\PETREL\Prizm\wf\Vienna\seismicFlowLines_2D_Panel_app\seismicFlowLines_2D_launcher.py
...
current_dir = r"N:\_USER_GLOBAL\PETREL\Prizm\wf\Vienna\seismicFlowLines_2D_Panel_app"
...
try:
    ...
    import seismicFlowLines_2D_constants as constants
...
# Updated script name
panel_script = str(app_root / "seismicFlowLines_2D_main.py")
...
if process.poll() is not None:
    ...
    # Updated URL
    url = "http://localhost:5006/seismicFlowLines_2D_main"
    print(f"Opening: {url}")
    webbrowser.open(url)
