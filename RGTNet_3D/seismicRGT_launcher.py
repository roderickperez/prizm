...
current_dir = r"N:\_USER_GLOBAL\PETREL\Prizm\wf\Vienna\seismicRGT_Panel_app"
...
# --- 2. IMPORT CONSTANTS ---
try:
    import seismicRGT_constants as constants
...
pwr_description.add_object_ref_parameter(
    ...
    description="Select ONE seismic cube for RGT generation",
...
panel_script = str(app_root / "seismicRGT_main.py")
...
if process.poll() is not None:
    ...
    url = "http://localhost:5006/seismicRGT_main"
    print(f"Opening: {url}")
    webbrowser.open(url)
